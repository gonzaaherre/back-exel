    ...
    public byte[] generateInstrumentoPdf(Long instrumentoId) throws IOException {
        ...
        try (PDDocument document = new PDDocument();
            ...
            try (PDPageContentStream contentStream = new PDPageContentStream(document, page)) {
                ...
                //logo
                try(InputStream logoUtn = new URL("https://iconape.com/wp-content/png_logo_vector/utn.png").openStream()){
                    PDImageXObject pdImageXObject = PDImageXObject.createFromByteArray(document,logoUtn.readAllBytes(),"logo");
                    contentStream.drawImage(pdImageXObject,100,748,98,98);
                ...
                addText(contentStream, instrumento.getCostoEnvio(), PDType1Font.HELVETICA, 9, 350, 550);
